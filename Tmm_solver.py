...
my_solar_cell = SolarCell([AlGaAs(T)], T=T, R_series=0, substrate=substrate,kind='PDD')
...
x = input('want to continue to print my solar cell')
print('start')
print(my_solar_cell)
# for attr, value in my_solar_cell.__dict__.items():
#     input("Press Enter to continue...")
#     print(attr, value)

# print('yoyo stop')
# print(type(my_solar_cell.IV))
# print(my_solar_cell.IV)
x = input('want to continue Iv')
print(my_solar_cell.iv["IV"][1])
x = input('want to continue')
# print(my_solar_cell.iv.IV[1])

# # And the IV curves of the individual junctions and of the MJ device
plt.figure(2)
plt.plot(V, abs(my_solar_cell.iv.IV[0]), 'b', label='AlGaAs')
plt.plot(V, abs(my_solar_cell.iv.IV[1]), 'r', label='GaAs')
