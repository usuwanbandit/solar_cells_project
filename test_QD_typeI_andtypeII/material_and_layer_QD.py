...
#     Layer(width=si("15 nm"), material=i_GaAs_barrier, role="barrier"),
...
def my_solar_cell():
    ...
    p_GaInP = material("GaInP")(T=T, In=0.35, Na=si("2e17 cm-3"))
    ...
    GaAs_junction = Junction([
        ...
        # Layer(width=si("30 nm"), material=n_GaAs_min, role="Emitter"),
                             ]
        + QW_list
        +[
        # Layer(width=si("45 nm"), material=p_GaInP, role="BSF"),
        # Layer(width=si("200 nm"), material=p_GaAs_min, role="BSF"),
...
def solar_cell_InAs_GaSb():
    ...
    GaAs_junction = Junction([
        Layer(width=si("230 nm"), material=n_GaAs, role="Emitter"),
        Layer(width=si("100 nm"), material=n_GaAs, role="Emitter"),
        Layer(width=si("2500 nm"), material=p_GaAs, role="Base"),
        ]+
        QW_list
        +
        [Layer(width=si("2500 nm"), material=p_GaAs, role="Base"),
...
def solar_cell_InAs_GaSb_sweep_interlayer():
    playload_solar_cell = {}
    interlayer = [5, 10, 15, 20, 25]
    for i in interlayer:
        size_InAs = 11
...
def solar_cell_InAs_GaSb_sweep_stack():
    playload_solar_cell = {}
    stack = [5, 4, 3, 2, 1]
    for i in stack:
        size_InAs = 11
...
def QDSC_InSb_and_GaSb_barrier_mod():
    ...
    for top_barrier in top_barriers:
        for bot_barrier in bottom_barriers:
            ...
            AlGaAs = material("AlGaAs")(T=T, Al=0.3, strained=True)
            n_AlGaAs = material("AlGaAs")(T=T, Al=0.3, strained=True,Nd=si("3e17 cm-3"), electron_mobility=si("2000 cm2"), hole_mobility=si("50 cm2"))
            n_GaAs = material('GaAs')(T=T, Nd=si('1e18 cm-3'), )
            n_AlInP = material("AlInP")(T=T, Al=0.42, Nd=si('3e17 cm-3'), electron_mobility=si("400 cm2"), hole_mobility=si("30 cm2"))
...
def QDSC_InSb_and_GaSb_stack_dot():
    size_InSb = 2.5
    size_GaSb = 20
    dot_stack = [1, 2, 3, 4, 5]
    solar_each_function = {}
    for stack in dot_stack:
        ...
        solarcell_InSb_GaSb = SolarCell([
            ...
            , T=T, substrate=p_GaAs)
        solar_each_function[f"stack = {stack}"] = solarcell_InSb_GaSb
    return solar_each_function
